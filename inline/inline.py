...
button_category4 = InlineKeyboardButton('Смена языка', callback_data='Смена языка')

keyboard_main = InlineKeyboardMarkup(row_width=1)
keyboard_main.add(button_category1, button_category2, button_category3, button_category4)
